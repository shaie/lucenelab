...
/**
   * A {@link TeeSinkTokenFilter.SinkFilter} which accepts colors. It stores on
   * the {@link AttributeSource} an {@link AnnotationSpanAttribute} recording
   * the start position (in the original text) and the length (usually 1) of the
   * identified color.
   */
  public final class ColorsSinkFilter extends TeeSinkTokenFilter.SinkFilter {

    private static final CharArraySet COLORS = new CharArraySet(Arrays.asList("black", "blue", "brown", "red", "green"), true);
