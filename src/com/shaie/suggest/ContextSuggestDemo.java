...
public class ContextSuggestDemo {
    ...
    public ContextSuggestDemo() throws IOException {
        ...
        suggester = new AnalyzingInfixSuggester(Constants.VERSTION, suggestDir, analyzer, analyzer, 1);
        buildSearchIndex();
        buildSuggesterIndex();
    }
    ...
    public void lookupNoContext() throws IOException {
        ...
        List<LookupResult> lookups = suggester.lookup("qu", null, 10, true, true);
