...
public class AnnotatorTokenFilterExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        searchForQuickFollowedByBrown(searcher);
        System.out.println();

        search(searcher, qp.parse("animal:* AND color:*"));
        System.out.println();

        search(searcher, qp.parse("animal:* AND color:brown"));
        System.out.println();
    ...
    private static void searchForQuickFollowedByBrown(IndexSearcher searcher) throws IOException {
        ...
        final SpanQuery quick = new SpanTermQuery(new Term(TEXT_FIELD, "quick"));
        search(searcher, new SpanNearQuery(new SpanQuery[] { quick, brownText }, 1, true));
    }
